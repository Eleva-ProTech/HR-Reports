      ...
      <CrudFormModal
        ...
        formConfig={{
          fields: [
            ...
            { name: 'date', label: t('Date'), type: 'date', required: true, defaultValue: new Date().toISOString().split('T')[0] },
            { name: 'clock_in', label: t('Clock In Time'), type: 'time', defaultValue: formMode === 'create' ? new Date().toTimeString().slice(0,5) : '' },
            { name: 'clock_out', label: t('Clock Out Time'), type: 'time', defaultValue: formMode !== 'create' ? new Date().toTimeString().slice(0,5) : '' },
